...
class PomodoroState {
  ...
  int get elapsedSeconds {
    ...
    final asOf = c.status == PomodoroStatus.paused ? c.pausedAt! : (now ?? c.startTime);
    final raw = asOf.difference(c.startTime).inSeconds - c.accumulatedPauseSeconds;
    return raw < 0 ? 0 : raw;
  }
  ...
  bool get isOvertime => current != null && elapsedSeconds > current!.durasiMenit * 60;
