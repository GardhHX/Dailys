...
/// and form.
String tugasStatusLabel(TugasStatus status, AppLocalizations l10n) => switch (status) {
...
String tugasPriorityLabel(TugasPrioritas p, AppLocalizations l10n) => switch (p) {
