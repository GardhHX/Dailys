...
class PomodoroSession extends Table with TombstoneColumns, OriginColumn {
  ...
  DateTimeColumn get pausedAt => dateTime().named('paused_at').nullable()(); // Instant
...
class TimeboxSchedule extends Table with TombstoneColumns, OriginColumn {
  ...
  TextColumn get tanggalSpesifik => text().named('tanggal_spesifik').nullable()();
...
class TimeboxExecution extends Table with TombstoneColumns, OriginColumn {
  ...
  DateTimeColumn get plannedStartAt => dateTime().named('planned_start_at')(); // Instant
  DateTimeColumn get plannedEndAt => dateTime().named('planned_end_at')(); // Instant
